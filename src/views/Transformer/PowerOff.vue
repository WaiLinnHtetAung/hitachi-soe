...
.poweroff-carousel .swiper-pagination .swiper-pagination-bullet-active {
  width: 9px;
  height: 9px;
  background: linear-gradient(to right, #2d0b00, var(--btn-color));
}

.poweroff-carousel .swiper-button-next,
.poweroff-carousel .swiper-button-prev {
  color: rgb(204, 204, 204, 0.5);
  font-weight: bold;
}

.poweroff-carousel .swiper-button-next:after,
.poweroff-carousel .swiper-button-prev:after {
  font-size: 30px;
}
