<template>
    <div class="profile">
       ...
       <img data-aos="zoom-in" src="@/assets/images/carousel2.jpg" alt="">

    </div>

    <div class="chairman-md">
        <h2>Chairman & Director</h2>

        <div class="img">
            <div class="img-card" data-aos="fade-right">
   ...
   <div class="overview">
    ...
    <table class="table table-bordered table-responsive">
        ...
        <tr data-aos="flip-up">
            ...
            <td>Distribution Transformer…8000Pcs/yr Over</td>
        </tr>
        <tr data-aos="flip-up">
            <td>Power Transformer…800,000 kVA/yr</td>
        </tr>
        <tr data-aos="flip-up">
        ...
        <tr data-aos="flip-up">
            ...
            <td>Government Tender Project, System Improvement Project, Industrial Zone, Construction</td>
        </tr>
    </table>
   </div>
</template>
...
<style scoped>
    ...
    .chairman-md img {
        ...
        border-radius: 4px;
        background: linear-gradient(to right, rgb(214, 218, 169), rgb(247, 248, 233));
        border: 1px solid goldenrod;
    }

    .chairman-md .position h2 {
        text-align: center;
        font-size: 20px;
    }

    .chairman-md .position h3 {
        text-align: center;
        font-weight: bold;
        margin-top: -10px;
    }
